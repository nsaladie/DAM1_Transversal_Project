...
<body>
    ...
    <div class="form">
        ...
        <form id="form_signup" action="../Controller/UserController.php" method="post" enctype="multipart/form-data">
            <div class="name">
                <input type="text" name="name" style="background-color:transparent;border: 0;" required placeholder="NAME" pattern="[A-Za-z\s]+">
            </div>
            <div class="surname">
                <input type="text" name="surname" style="background-color:transparent;border: 0;" required placeholder="SURNAME" pattern="[A-Za-z\s]+">
            </div>
            <div class="email">
                <input type="email" name="username" style="background-color:transparent;border: 0;" required placeholder="EMAIL">
            </div>
            <div class="password">
                <input type="password" name="password" style="background-color:transparent;border: 0;" required placeholder="PASSWORD" pattern="^(?=.*[0-9])(?=.*[a-zA-Z]).{8,}$">
            </div>
            <input type="hidden" name="admin">
            <div class="icon">
                Icon Profile:<input type="file" name="file" id="uploadFile">
            </div>
